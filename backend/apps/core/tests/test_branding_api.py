...
class BrandingAPITest(APITestCase):
    ...
    def test_current_branding_and_update_require_staff(self):
        ...
        res_forbidden = self.client.put('/api/core/branding/update_current/', {"company_name": "New Name"}, format='json')
    ...
    def test_email_config_get_and_put_require_staff_for_put(self):
        ...
        self.user.is_staff = True
        self.user.save(update_fields=['is_staff'])
        res_put = self.client.put('/api/core/branding/email_config/', {
