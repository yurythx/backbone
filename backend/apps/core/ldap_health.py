    ...
    def get(self, request):
        ...
        try:
            ...
            for config in active_configs:
                ...
                status_detail['tls'] = "LDAPS" if use_ssl else ("StartTLS" if getattr(config, 'use_tls', False) else "None")
                ...
                if info:
                    ...
                    metrics_suffix = f" | tempos: bind={bind_ms}ms, search={search_ms}ms" + (f", group={group_ms}ms" if group_ms is not None else "")
