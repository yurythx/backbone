...
class ArticleHistoryAPITest(APITestCase):
    ...
    def test_history_and_revert(self):
        ...
        revert_res = self.client.post(f'/api/articles/articles/{self.article.id}/revert/', {"version_id": target_id}, format='json')
