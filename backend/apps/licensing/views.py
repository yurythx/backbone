...
from .serializers import (
    FeatureSerializer, PlanSerializer, LicenseSerializer, UsageResponseSerializer
)
...
@extend_schema_view(
    ...
    usage=extend_schema(tags=['Licensing'], responses={200: UsageResponseSerializer}, summary="Get current usage vs limits"),
    checkout=extend_schema(tags=['Licensing'], responses={201: LicenseSerializer}, summary="Checkout/Simulate plan upgrade"),
)
