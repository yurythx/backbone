            ...
            >
                ...
                {!isSubmitted ? (
                    ...
                    <div className="text-center p-8 bg-primary/5 rounded-2xl border border-primary/20 animate-in fade-in zoom-in duration-500">
                        ...
                        <Button variant="outline" className="mt-6 w-full rounded-xl" onClick={() => setIsSubmitted(false)}>
                            Tentar outro email
                        </Button>
                    </div>
                )}
                ...
                <div className="text-center text-sm text-muted-foreground">
                    Ainda não tem conta? <Link href="/register" className="text-primary font-bold hover:underline">Solicite acesso</Link>
                </div>
            </motion.div>
        </div>
    )
